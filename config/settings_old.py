...
# Advanced Database Configuration for OLTP
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',  # For CockroachDB compatibility
        'NAME': os.getenv('DB_NAME', 'university_db'),
        'USER': os.getenv('DB_USER', 'university_user'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'university_pass'),
    ...
    'olap': {
        ...
        'NAME': os.getenv('CLICKHOUSE_DB', 'university_analytics'),
...
KAFKA_TOPICS = {
    'user_events': 'university.user.events',
    'student_events': 'university.student.events',
    'employee_events': 'university.employee.events',
    'audit_events': 'university.audit.events',
}
...
MINIO_BUCKET_NAME = os.getenv('MINIO_BUCKET_NAME', 'university-files')
MINIO_SECURE = os.getenv('MINIO_SECURE', 'False').lower() == 'true'

# Elasticsearch Configuration
ELASTICSEARCH_HOST = os.getenv('ELASTICSEARCH_HOST', 'localhost:9200')
ELASTICSEARCH_INDEX_PREFIX = 'university_'
