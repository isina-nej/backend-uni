# ==============================================================================
# SIMPLIFIED DJANGO SETTINGS FOR PYTHONANYWHERE DEPLOYMENT
# تنظیمات ساده‌شده برای استقرار در PythonAnywhere
# ==============================================================================
...
# Only include apps that don't require channels or complex dependencies
LOCAL_APPS = [
    'apps.users',
    'apps.common',
    'apps.courses',
    ...
    'apps.library',
    'apps.financial',
    # 'apps.notifications',  # Temporarily disabled due to channels dependency
    'apps.analytics',
    'apps.data_management',
    'apps.mobile_api',
    # 'apps.ai_ml',  # May have heavy dependencies
    'apps.reports',
    'apps.research',
    'apps.announcements',
    'apps.assignments',
...
# Default from email
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@sinanej2.pythonanywhere.com')
