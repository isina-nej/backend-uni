"""
WSGI config for PythonAnywhere deployment - DIRECT SETTINGS VERSION
Uses direct hardcoded settings without environment variables
"""
...
# Set Django settings module to use direct settings
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'config.settings_production_direct')
